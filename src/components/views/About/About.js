    ...
    return(
      <div className='pageContent'>
        <div className='about'>
          ...
          Ćwiczę i rozwijam swoje umiejętności w JavaScript, React, HTML5 oraz CSS/Sass.
          Wiem, że jestm na początku tej drogi, ale jestem zmotywowany, aby stawiać kolejne kroki.
          </div>
        </div>
      </div>
    );
